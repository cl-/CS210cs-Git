	...
	public background(Composite parent, int style) {
		...
		btnAddBudget.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				//if statement here to check if user enter correctly
			}
		});
		...
		btnAddMiscItem.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				Button randombutton = new Button(composite_1, SWT.NONE);
				randombutton.setBounds(410, 196, 75, 25);
				toolkit.adapt(randombutton, true, true);
